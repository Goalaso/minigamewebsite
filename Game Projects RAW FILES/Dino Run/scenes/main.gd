...
var score : int
const SCORE_MODIFIER : int = 10 * 60
var high_score : int
var speed : float
...
func _ready():
	...
	$GameOver.get_node("Button2").pressed.connect(send_high_score)
	new_game()
...
func show_score():
	$HUD.get_node("ScoreLabel").text = "SCORE: " + str(score * 100 / SCORE_MODIFIER)
...
func check_high_score():
	...
	if score > high_score:
		high_score = score
		$HUD.get_node("HighScoreLabel").text = "HIGH SCORE: " + str(high_score * 100 / SCORE_MODIFIER)
		$GameOver/Button2.show()
		$GameOver/Button2.disabled = false

func send_high_score():
	var myurl = "/score.php"
	var dict = {"game": "dino", "score": high_score * 100 / SCORE_MODIFIER}
	$GameOver/Button2.disabled = true
	$GameOver/Label.show()
